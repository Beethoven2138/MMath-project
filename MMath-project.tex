...
\noindent $S^3$ is a compact manifold (since it can be proven to be a submanifold, and hence a manifold, by the regular value theorem from MA40254) and the action of $\mathbb{Z}_p$ is free so $L(p;q)$ is a $3$--manifold.
