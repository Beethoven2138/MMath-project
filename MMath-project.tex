...
$\gamma(e)=q$.\\
$p\alpha([Sx_{q-1}x_q])=p\alpha([Nx_{p-1}x_0])=p\alpha(b_{p-1})=(p-1+1)\delta_{b_{p-1}}(b_{p-1})-(0)\delta_{b_{p-1}}(b_{p-1})=p\implies \alpha([Sx_{q-1}x_q])=1$.\\
Otherwise, $p\alpha([Sx_ix_{i+1}])=\pm p\alpha([Nx_{i-q}x_{i+1-q}])=\pm p\alpha(b_{i-q})=\pm((kp+i-q+1)\delta_{b_{{i-q}}}-(kp+i-q+1)\delta_{b_{{i-q}}})=0$, where $k\in\mathbb{Z}$ puts $kp+i-q+1$ in the compatible range for the sum of $[0,p-1]$.\\
