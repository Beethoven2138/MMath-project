...
\begin{definition}
A homeomorphism $f$ from an open subset $V$ of $\mathbb{R}^n$ to another open subset $V_{'}$ is \textbf{orientation preserving} if 
\end{definition}
...
\begin{theorem}
let $M$ be a closed connected $n$--manifold. Then $M$ is orientable iff $H_n(M)\cong\mathbb{Z}$.
\end{theorem}
An orientation can the be defined as a choice of fundamental class.
