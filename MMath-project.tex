...
$\gamma(e)=q$.\\
$p\alpha([Sx_0x_{p-1}])=p\alpha(b_{p-1})=(p-1+1)\delta_{B_{p-1}}(-B_{p-1})-(0)\delta_{B_{p-1}}(-B_{p-1})=-p\implies \alpha([Sx_0x_{p-1}])=-1$.\\
Otherwise, $p\alpha([Sx_ix_{i+1}])=p\alpha(b_i)=(i+1)\delta_{B_{i}}-(i+1)\delta_{B_{i}}=0$.\\
Thus $[\alpha]\vee[\alpha]=-\frac{1}{p}\gamma([NS])\alpha([Sx_0x_{p-1}])=\frac{q}{p}$.\\
